...
import { ChartLine, ServerCog, Users, Lightbulb, Database, MessageSquare, Rocket, Phone, Mail, MapPin } from "lucide-react";
...
export default function Home() {
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'We partner with political leaders to design and execute impactful strategies for community transformation. Specializing in grassroots engagement and policy delivery in Kenya.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'We partner with political leaders to design and execute impactful strategies for community transformation. Specializing in grassroots engagement and policy delivery in Kenya.';
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <div className="inline-flex items-center bg-tawi-accent/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                <span className="text-tawi-accent font-medium text-sm">Strategic Political Consulting</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-montserrat font-bold text-white mb-6 leading-tight">
                Where Leadership<br />
                <span className="text-tawi-accent bg-gradient-to-r from-tawi-accent to-yellow-400 bg-clip-text text-transparent">Meets Delivery</span>
              </h1>
              
              <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
                We partner with political leaders across Kenya to design and execute impactful strategies for community transformation through grassroots engagement and policy delivery.
              </p>
            ...
            <div className="relative lg:block hidden">
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">Quick Consultation</h3>
                    <p className="text-white/70 text-sm">Get strategic insights for your next campaign</p>
                  </div>
                </div>
                
                <div className="space-y-4 text-white/80 text-sm">
                  <div className="flex items-center">
                    <svg className="w-4 h-4 text-tawi-accent mr-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
            ...
            <div className="mt-12 lg:mt-0">
              <div className="inline-flex items-center bg-tawi-accent/10 rounded-full px-4 py-2 mb-6">
                <span className="text-tawi-accent font-medium text-sm">About Tawi Group</span>
              </div>
              
              <h2 className="text-4xl md:text-5xl font-montserrat font-bold text-tawi-primary mb-6 leading-tight">
                Empowering Leaders, <span className="text-tawi-accent">Transforming Communities</span>
              </h2>
              
              <p className="text-lg text-tawi-text/80 mb-6 leading-relaxed">
                Tawi Group is a consulting agency that partners with political leaders to design and execute impactful strategies for community transformation. We specialize in grassroots engagement, policy delivery plans, and campaign alignment with real citizen needs.
              </p>
              
              <p className="text-lg text-tawi-text/80 mb-8 leading-relaxed">
                We root our strategies in data, dialogue, and development — ensuring leaders don't just win elections, but deliver lasting impact for their communities across Kenya.
              </p>
              ...
              <div className="bg-tawi-neutral/50 rounded-2xl p-6 mb-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-tawi-primary">Trusted Partners</div>
                      <div className="text-sm text-tawi-text/70">Emerging & seasoned leaders</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-tawi-primary">Local Networks</div>
                      <div className="text-sm text-tawi-text/70">Deep roots across Kenya</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* What We Do Section */}
      <section id="services" className="py-24 bg-gradient-to-br from-gray-50 to-tawi-neutral/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-tawi-primary/10 rounded-full px-6 py-2 mb-6">
              <span className="text-tawi-primary font-medium">Our Expertise</span>
            </div>
            ...
            <p className="text-xl text-tawi-text/70 max-w-3xl mx-auto leading-relaxed">
              We provide comprehensive political consulting services that empower leaders to create meaningful change in their communities across Kenya.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-montserrat font-bold text-tawi-primary mb-4">Community Project Design</h3>
                  <p className="text-tawi-text/70 leading-relaxed mb-4">
                    Tailored programs that build credibility before campaigns and create lasting community impact through strategic grassroots initiatives.
                  </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-montserrat font-bold text-tawi-primary mb-4">Constituency Delivery Planning</h3>
                  <p className="text-tawi-text/70 leading-relaxed mb-4">
                    Transforming manifestos into measurable, trackable action plans that deliver real results for constituents.
                  </p>
                  <ul className="space-y-2 text-sm text-tawi-text/60">
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-tawi-accent rounded-full mr-3"></div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-montserrat font-bold text-tawi-primary mb-4">Campaign Visibility & Voter Mobilization</h3>
                  <p className="text-tawi-text/70 leading-relaxed mb-4">
                    Strategic branding and messaging rooted in local realities to maximize voter engagement and campaign effectiveness.
                  </p>
                  <ul className="space-y-2 text-sm text-tawi-text/60">
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-tawi-accent rounded-full mr-3"></div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-montserrat font-bold text-tawi-primary mb-4">Stakeholder Engagement</h3>
                  <p className="text-tawi-text/70 leading-relaxed mb-4">
                    Mobilizing NGOs, CBOs, and government bodies for effective partnerships and collaborative governance.
                  </p>
                  <ul className="space-y-2 text-sm text-tawi-text/60">
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-tawi-accent rounded-full mr-3"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Our proven methodology combines three essential elements for sustainable transformation
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-montserrat font-semibold text-white mb-4">Data</h3>
              <p className="text-white/80 leading-relaxed">
                Evidence-based insights drive every recommendation. We leverage advanced analytics to uncover patterns and opportunities that inform strategic decisions.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-montserrat font-semibold text-white mb-4">Dialogue</h3>
              <p className="text-white/80 leading-relaxed">
                Meaningful stakeholder engagement ensures buy-in and sustainable implementation. We facilitate conversations that build consensus and drive action.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-montserrat font-semibold text-white mb-4">Development</h3>
              <p className="text-white/80 leading-relaxed">
                Continuous improvement and capacity building create lasting organizational change. We don't just consult—we develop internal capabilities.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-tawi-neutral rounded-2xl p-8 md:p-12">
            ...
            <div className="mt-12 text-center">
              <blockquote className="text-xl md:text-2xl text-tawi-text italic mb-6 max-w-4xl mx-auto">
                "Tawi Group helped us transform our constituency engagement strategy. Their deep understanding of local dynamics and practical approach delivered tangible results for our community."
              </blockquote>
              <div className="flex items-center justify-center space-x-4">
                ...
                />
                <div className="text-left">
                  <div className="font-semibold text-tawi-primary">Joseph Mwangi</div>
                  <div className="text-sm text-tawi-text/70">County Assembly Member, Kiambu</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-24" style={{ backgroundColor: '#1E372F' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white max-w-3xl mx-auto leading-relaxed">
              Let's discuss how Tawi Group can help you achieve your political objectives through strategic consulting and community engagement.
            </p>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-5 lg:gap-12 items-start">
            <div className="lg:col-span-2 mb-12 lg:mb-0">
              <div className="bg-white/15 backdrop-blur-lg rounded-2xl p-8 border border-white/30">
                <h3 className="text-2xl font-montserrat font-bold text-white mb-6">Contact Information</h3>
                
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#B38629' }}>
                      <Phone className="text-white w-5 h-5" />
                    </div>
                    <div>
                      <div className="font-semibold text-white">Phone</div>
                      <div className="text-white/80">+254 01 234567</div>
                      <div className="text-white/60 text-sm mt-1">Mon-Fri 8AM-6PM EAT</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/80">tawi.group.1@gmail.com</div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/60 text-sm mt-1">By appointment</div>
                    </div>
                  </div>
                </div>
                
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="text-white/80 text-sm mb-4">Follow us on social media</div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div className="p-8">
                  <h3 className="text-2xl font-montserrat font-bold text-tawi-primary mb-2">Start Your Project</h3>
                  <p className="text-tawi-text/70 mb-6">Fill out the form below and we'll get back to you within 24 hours to discuss your political consulting needs.</p>
                  <ContactForm />
                </div>
              </div>
            </div>
