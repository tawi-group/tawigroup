    ...
    <footer className='bg-tawi-primary text-white py-12'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div>
            <div className='flex items-center mb-4'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-sm font-montserrat font-semibold text-white/90'>
                  GROUP
                </span>
              </div>
            </div>
            <p className='text-white/80 mb-6'>
              Strategic consulting for public impact. Where leadership meets
              delivery.
            </p>
          ...
          <div>
            ...
            <ul className='space-y-2 text-white/80'>
              <li>
                <a
                  href='#services'
                  className='hover:text-tawi-accent transition-colors duration-200'
                >
        ...
        <div className='border-t border-white/20 mt-8 pt-8 text-center text-white/60'>
          <p>
            &copy; {new Date().getFullYear()} Tawi Group. All rights reserved. |
